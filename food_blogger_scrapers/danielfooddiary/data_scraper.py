...
def get_search_links(page, keyword, name):
    browser.get("https://danielfooddiary.com/page/%d/?s=%s" % (page,keyword))
    WebDriverWait(browser, 30).until(is_ready)
    main_content = browser.find_element(By.CLASS_NAME, "td-ss-main-content")
    results = main_content.find_elements(By.CLASS_NAME, "item-details")
    matching_results = []
